...
pub mod parse_amount_old {
    ...
    use mvv_common_bank_entities::currency::parse::CurrencyFormatError;
    ...
    // Full type or short type can be used: ParseAmountError/crate::amount::parse::ParseAmountError
    ...
    pub enum ErrorSource {
        ...
        // for testing
        // CurrencyFormatError22(crate::currency::parse_currency::CurrencyFormatError),
