...
pub mod parse_currency_another_01 {
    ...
    pub struct CurrencyFormatError {
        ...
        pub backtrace: mvv_common::backtrace::BacktraceInfo,
    }
    ...
    impl BacktraceCopyProvider for CurrencyFormatError {
        fn provide_backtrace(&self) -> BacktraceInfo { self.backtrace.test_clone() }
    }
...
use mvv_common::backtrace::{is_anyhow_backtrace_enabled, NewBacktracePolicy};
