...
pub mod parse_currency_another_01 {
    ...
    pub struct CurrencyFormatError {
        ...
        pub backtrace: mvv_common::backtrace2::BacktraceCell,
    }
    ...
    impl BacktraceCopyProvider for CurrencyFormatError {
        fn backtrace_ref(&self) -> BacktraceInfo { self.backtrace.test_clone() }
    }
...
pub mod parse_amount_another_01 {
    ...
    //     fn backtrace_ref(&self) -> BacktraceInfo { BacktraceInfo::empty() }
    // }
    */
}
...
fn test_currency_format_error_new() {
    ...
    assert_contains!(err.backtrace_ref().to_test_string(), "capture");
}
...
fn test_currency_format_error_with_backtrace() {
    ...
    if is_anyhow_backtrace_enabled() {
        ...
        assert_contains!(err.backtrace_ref().to_test_string(), "Backtrace disabled");
    }
    ...
    assert_contains!(err.backtrace_ref().to_test_string(), "force_capture");
}
*/
