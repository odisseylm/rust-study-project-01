...
pub mod parse_currency {
    ...
    impl CurrencyFormatError {
        ...
        pub fn new(kind: ErrorKind) -> CurrencyFormatError {
            CurrencyFormatError { kind, backtrace: BacktraceInfo::new() }
        }
        // It can be generated by macro
        pub fn with_backtrace(kind: ErrorKind, backtrace_policy: NewBacktracePolicy) -> CurrencyFormatError {
            CurrencyFormatError { kind, backtrace: BacktraceInfo::new_by_policy(backtrace_policy) }
        }
    }
