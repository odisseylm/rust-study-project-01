...
pub mod usage_test_is_main_src {
    ...
    // pub type TypeAliasByInternalCrateTypePath = crate::util::backtrace::NewBacktracePolicy;
    pub type TypeAliasByExternCrateTypePath1 = project01::util::backtrace::NewBacktracePolicy;
    // not compiled
    // pub type TypeAliasByExternCrateTypePath2 = ::project01::util::backtrace::NewBacktracePolicy;
}
