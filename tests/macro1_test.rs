...
//
// include!("./../_subpackages/static_error_macro/tests/macro1_test.rs");
...
use project01::entities::currency::{CurrencyFormatError, parse::ErrorKind as CurErrorKind };
...
fn test_amount_format_error_with_source() {
    ...
    use project01::entities::currency::{ self, parse::CurrencyFormatError };
    use project01::entities::amount::parse::{ ErrorKind, ErrorSource };
